...
public class DetalleActivity extends AppCompatActivity {
    ...
    private TextView tv_detalle_nombres, tv_detalle_numeros;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_detalle_numeros = findViewById(R.id.tv_detalle_numeros);
            ...
            reference.child(id).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (model != null){
                        ...
                        tv_detalle_numeros.setText(model.get_numero());
                    }
                }
        ...
        fab_detalle_eliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar snackbar = Snackbar.make(view, "Seguro que deseas eliminar?", Snackbar.LENGTH_LONG);
